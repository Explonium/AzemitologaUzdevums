...
{
    public class FigureRhombusExcluded : Figure
    {
        public int? Width { get; set; }
        public int? Height { get; set; }

        public FigureRhombusExcluded(View view) : base(view)
        {
        }
        ...
        public override void Render()
        {
            ...
            var width = Width ?? (Size) * 4 - 2;
            var height = Height ?? (Size) * 2 + 2;
            ...
            for(int y = 0; y < halfHeight; y++)
            {
                ...
                {
                    if (x <= halfWidth - y * 2 || x >= halfWidth + y * 2)
                    {
